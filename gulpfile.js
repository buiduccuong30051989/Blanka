...
var options = {
  ...
  revo: {
    in: [baseDirs.source + 'revolution-slider/**/*.*'],
    out: baseDirs.dest + 'revolution-slider/'
  },
  images: {
...
gulp.task('copy-images', function() {
  return gulp.src(options.images.in).pipe(gulp.dest(options.images.out));
});

// Copy Public
gulp.task('copy-public', function() {
  return gulp.src(options.public.in).pipe(gulp.dest(options.public.out));
});

// Copy Revolution slider
// gulp.task('copy-revolution-slider', function() {
//   return gulp
//     .src(options.revo.in)
//     .pipe(gulp.dest(options.revo.out));
// });
...
gulp.task('cleanup', function(cb) {
  return del(
    ['dest/**/*', '!dest/revolution-slider', '!dest/revolution-slider/**/*'],
    cb
  );
});
